...
export const BtnList = [
  ...
  {
    label: "Github",
    link: "https://github.com/Mokim2005",
    icon: "github",
    newTab: true,
  },
  {
    label: "LinkedIn",
    link: "https://www.linkedin.com/in/abdul-mokim/",
    icon: "linkedin",
    newTab: true,
  },
  {
    label: "X",
    link: "https://x.com/AbdulMokim40428",
    icon: "twitter",
    newTab: true,
  },
  {
    label: "Resume",
    link: "https://docs.google.com/document/d/1PMXf1jmYjMe_i7s6sIcHoSKJ52TPp6saFqrVioPseac/edit?tab=t.0",
    icon: "resume",
    newTab: true,
  },
];
